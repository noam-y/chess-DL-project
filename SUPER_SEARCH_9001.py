...
def main():
    ...
    for combination_idx, (heads, sampling, use_triplet, freeze) in enumerate(itertools.product(heads_opts, sample_opts, triplet_opts, freeze_opts), 1):
        ...
        for val_game in all_games:
            ...
            train_loader = DataLoader(train_ds, batch_size=32, sampler=sampler, shuffle=(sampler is None), num_workers=4, collate_fn=custom_collate)
